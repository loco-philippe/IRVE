...
- intégration des stations autoroutes (+ analyse des aires et échangeurs)
- identification des stations IRVE autoroutes
- extension de l'outil d'analyse autoroutes
- ajout des fonctions liées à l'historisation
- ajout des indicateurs autoroutes (a1, a2, a3, a4, a7, a8), temporels (d1, d2, d3) et d'état (e1)
